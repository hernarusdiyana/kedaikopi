...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url('assets/fontawesome-6.5.1/css/fontawesome.min.css') ?>">
  <link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/admin_style.css') ?>">
  <link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/admin_style2.css') ?>">
...
<body class="bg-gray-100">
  ...
  <!-- start navbar -->
  <div class="md:fixed md:w-full md:top-0 md:z-20 flex flex-row justify-between items-center bg-white p-6 border-b border-gray-300">
...
<button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
	<div class="w-8 h-8 overflow-hidden rounded-full">
		<img class="w-full h-full object-cover" src="<?= base_url('assets/admin_assets/img/user.svg') ?>">
	</div>
...
<div class="text-gray-500 menu hidden md:mt-10 md:w-full rounded bg-white shadow-md absolute z-20 right-0 w-40 mt-5 py-2 animated faster">
	...
	<!-- item -->
	<a class="px-4 py-2 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 hover:text-gray-900 transition-all duration-300 ease-in-out" href="<?= base_url('admin/logout')?>">
...
<!-- end user -->
        ...
        <div class="dropdown relative mr-5 md:static">
          ...
          <div class="menu hidden md:w-full md:right-0 rounded bg-white shadow-md absolute z-20 right-0 w-84 mt-5 py-2 animated faster">
            ...
            <a class="flex flex-row items-center justify-start px-4 py-4 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 transition-all duration-300 ease-in-out" href="#">
              ...
              <div class="flex-1 flex flex-rowbg-green-100">
                <div class="flex-1">
                  <h1 class="text-sm font-semibold">eldrich</h1>
  ...
  <div class="h-screen flex flex-row flex-wrap">
    ...
    <div class="flex flex-col">
        ...
        <!-- link -->
        <a href="<?= base_url('admin')?>" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
