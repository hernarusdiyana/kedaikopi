...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__wobble" src="<?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/AdminLTELogo.png' ?>" alt="AdminLTELogo" height="60" width="60">
        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user1-128x128.jpg' ?>" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user8-128x128.jpg' ?>" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user3-128x128.jpg' ?>" alt="User Avatar"
                                    class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/AdminLTELogo.png' ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user2-160x160.jpg' ?>" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="direct-chat-messages">
                                                ...
                                                <div class="direct-chat-msg">
                                                    ...
                                                    <img class="direct-chat-img" src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user1-128x128.jpg' ?>"
                                                ...
                                                <div class="direct-chat-msg right">
                                                    ...
                                                    <img class="direct-chat-img" src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user3-128x128.jpg' ?>"
                                                        alt="message user image">
                                            ...
                                            <div class="direct-chat-contacts">
                                                <ul class="contacts-list">
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user1-128x128.jpg' ?>" alt="User Avatar">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user7-128x128.jpg' ?>" alt="User Avatar">
                                                            <div class="contacts-list-info">
                                                                <span class="contacts-list-name">
                                                                    Sarah Doe
                                                                    <small
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user3-128x128.jpg' ?>" alt="User Avatar">
                                                            <div class="contacts-list-info">
                                                                <span class="contacts-list-name">
                                                                    Nadia Jolie
                                                                    <small
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user5-128x128.jpg' ?>" alt="User Avatar">
                                                            <div class="contacts-list-info">
                                                                <span class="contacts-list-name">
                                                                    Nora S. Vans
                                                                    <small
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user6-128x128.jpg' ?>" alt="User Avatar">
                                                            <div class="contacts-list-info">
                                                                <span class="contacts-list-name">
                                                                    John K.
                                                                    <small
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user8-128x128.jpg' ?>" alt="User Avatar">
                                                            <div class="contacts-list-info">
                                                                <span class="contacts-list-name">
                                                                    Kenneth M.
                                                                    <small
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body p-0">
                                            <ul class="users-list clearfix">
                                                <li>
                                                    <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user1-128x128.jpg' ?>" alt="User Image">
                                                    <a class="users-list-name" href="#">Alexander Pierce</a>
                                                    <span class="users-list-date">Today</span>
                                                </li>
                                                <li>
                                                    <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user8-128x128.jpg' ?>" alt="User Image">
                                                    <a class="users-list-name" href="#">Norman</a>
                                                    <span class="users-list-date">Yesterday</span>
                                                </li>
                                                <li>
                                                    <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user7-128x128.jpg' ?>" alt="User Image">
                                                    <a class="users-list-name" href="#">Jane</a>
                                                    <span class="users-list-date">12 Jan</span>
                                                </li>
                                                <li>
                                                    <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user6-128x128.jpg' ?>" alt="User Image">
                                                    <a class="users-list-name" href="#">John</a>
                                                    <span class="users-list-date">12 Jan</span>
                                                </li>
                                                <li>
                                                    <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user2-160x160.jpg' ?>" alt="User Image">
                                                    <a class="users-list-name" href="#">Alexander</a>
                                                    <span class="users-list-date">13 Jan</span>
                                                </li>
                                                <li>
                                                    <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user5-128x128.jpg' ?>" alt="User Image">
                                                    <a class="users-list-name" href="#">Sarah</a>
                                                    <span class="users-list-date">14 Jan</span>
                                                </li>
                                                <li>
                                                    <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user4-128x128.jpg' ?>" alt="User Image">
                                                    <a class="users-list-name" href="#">Nora</a>
                                                    <span class="users-list-date">15 Jan</span>
                                                </li>
                                                <li>
                                                    <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/user3-128x128.jpg' ?>" alt="User Image">
                                    ...
                                    <ul class="products-list product-list-in-card pl-2 pr-2">
                                        <li class="item">
                                            <div class="product-img">
                                                <img src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/img/default-150x150.png' ?>" alt="Product Image"
                                                    class="img-size-50">
                                            </div>
    ...
    <script src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/plugins/jquery-mapael/maps/usa_states.min.js' ?>"></script>
    ...
    <script src=" <?php echo base_url() . 'assets/vendor/AdminLTE-3.2.0/dist/js/pages/dashboard2.js' ?>"></script>
</body>
