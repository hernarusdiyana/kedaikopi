<div class="container">
    ...
    <a href="<?php echo base_url().'admin/transaksi_add';?>" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Tambah Transaksi</a>
    <br><br>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        ?>
                        <a href="<?php echo base_url().'admin/transaksi_selesai/'.$t->transaksi_id; ?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-ok"> Transaksi Selesai</span></a>
                        <a href="<?php echo base_url().'admin/transaksi_hapus/'.$t->transaksi_id; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini?')"><span class="glyphicon glyphicon-trash"> Batalkan Transaksi</span></a>
                        <?php 
                        }
                        ?>
                    </td>
